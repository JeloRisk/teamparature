...
function KPI({ title, value, sub, glow, icon }: any) {
    return (
        <Card className="rounded-2xl bg-white shadow-sm hover:shadow-md transition border border-slate-200">
...
function ChartCard({ title, children }: { title: string; children: React.ReactNode }) {
    return (
        <Card className="rounded-2xl bg-white border border-slate-200 shadow-sm">
            <CardHeader>
                <CardTitle className="text-slate-700 text-base font-medium">{title}</CardTitle>
            </CardHeader>
